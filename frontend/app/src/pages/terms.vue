<template>
  ...
  <div class="min-h-screen bg-gray-50">
    <div class="container mx-auto px-4 py-10 max-w-3xl">
      ...
      <p class="mb-4">
        この利用規約（以下，「本規約」といいます。）は，当方がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。
        ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
      </p>

      <h2 class="text-2xl font-semibold mt-8 mb-4">第1条（適用）</h2>
      <p class="mb-4">
      ...
      <h2 class="text-2xl font-semibold mt-8 mb-4">第2条（禁止事項）</h2>
      <p class="mb-4">
      ...
      <p class="mb-4">
        本サービスに掲載しているイベントデータは、AIによる収集補助を含むため、誤りや最新ではない情報が含まれる可能性があります。ユーザーは、実際の参加判断、移動、予約その他の重要な判断を行う際には、必ず各イベントの公式ページ等で最新かつ正確な情報を確認するものとします。
      </p>

      <p class="mb-4">
        当方は、本サービスに掲載されたデータの誤り、不備、未更新又はそれらを信頼したことによりユーザーに生じた損失、損害その他の不利益について、一切の責任を負いません。
      </p>

      <h2 class="text-2xl font-semibold mt-8 mb-4">第5条（利用規約の変更）</h2>
      ...
      <p class="mb-4">本規約の解釈にあたっては，日本法を準拠法とします。</p>
